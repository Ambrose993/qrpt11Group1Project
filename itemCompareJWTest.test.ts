...
/*This test adds a number of shirts to the compare list.*/
  ...
  describe("Luma Test", () => {
      ...
      test("adding items to compare", async () => {
        ...
        await lPage.driver.wait(until.elementLocated(lPage.tops));
        await lPage.click(lPage.tops);
        await lPage.driver.wait(until.elementLocated(lPage.breathEasyTank));
        await lPage.click(lPage.breathEasyTank);
        await lPage.click(lPage.addToCompare)
        await lPage.click(lPage.womenSection);
        await lPage.driver.wait(until.elementLocated(lPage.tops));
        await lPage.click(lPage.tops);
        await lPage.driver.wait(until.elementLocated(lPage.chloeCompeteTank));
        await lPage.click(lPage.chloeCompeteTank);
        await lPage.click(lPage.addToCompare);
        await lPage.driver.wait(until.elementLocated(lPage.womenSection));
        await lPage.click(lPage.womenSection);
        await lPage.driver.wait(until.elementLocated(lPage.tops));
        await lPage.click(lPage.tops);
        await lPage.click(lPage.zoeTank);
        await lPage.click(lPage.addToCompare);
        await lPage.driver.wait(until.elementLocated(lPage.comparisonList));
        await lPage.click(lPage.comparisonList);
